  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <div className="text-center">
            <h1 className="text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              Pass the NREMT with
              <span className="block text-[#DAA520]">Confidence</span>
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="#courses"
                className="rounded-md bg-[#DAA520] px-6 py-3 text-lg font-semibold text-[#8B0000] shadow-lg hover:bg-[#B8860B] transition-colors"
              >
                View Courses
              </Link>
              <Link
                href="#testimonials"
                className="text-lg font-semibold leading-6 text-white hover:text-[#DAA520] transition-colors"
              >
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#8B0000]">95%</div>
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-[#8B0000]">10+</div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow">
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-2xl font-bold text-[#8B0000]">EMT Prep Course</h3>
                  <span className="text-3xl font-bold text-[#DAA520]">$200</span>
                </div>
                ...
                <button className="w-full bg-[#8B0000] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#660000] transition-colors">
                  Enroll Now
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow">
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-2xl font-bold text-[#8B0000]">Paramedic Prep Course</h3>
                  <span className="text-3xl font-bold text-[#DAA520]">$400</span>
                </div>
                <p className="text-gray-600 mb-6">
      ...
      <section className="py-20 bg-[#8B0000]">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#DAA520] text-[#8B0000] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#B8860B] transition-colors">
              Start Your Journey
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-[#8B0000] transition-colors">
              Contact Us
            </button>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-[#DAA520] mb-4">ABCEMS Solutions</h3>
